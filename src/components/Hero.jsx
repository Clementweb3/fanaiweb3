...
const Hero = () => {
  return (
    <div id='#' name="Hero" className="text-slate-200  mt-[80px] lg:h-screen w-full ">
      <div className={`${style.container} relative `}>
        <div className="flex flex-col justify-center h-full w-full md:pl-5">
          <h2 className="sm:text-[45px] lg:text-6xl text-4xl text-white ss:leading-[100px] md:leading-[75px] font-semibold py-4 ">Hello<span className='text-gradient'> Web3 </span> Citizens</h2>
          <Typed
          ...
          <div className='md:flex sm:flex-col mt-10'>
            ...
            <div className=" bg-blue-gradient
             rounded-md md:w-[300px]  w-[200px] md:m-0 mx-auto h-[10px] transform:rotate-[90deg] "/>
              ...
              <div className='md:absolute lg:h-[450px] lg:w-[420px] md:w-[280px] h-[300px] lg:right-3 lg:top-20  sm:right-12 sm:w-[300px] w-[280px] sm:top-12 mx-auto border-b border-white'>
                <Canvas>        
